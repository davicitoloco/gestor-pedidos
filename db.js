...
addColIfMissing('orders', 'discount2', 'REAL NOT NULL DEFAULT 0');
addColIfMissing('orders', 'discount3', 'REAL NOT NULL DEFAULT 0');
addColIfMissing('orders', 'discount4', 'REAL NOT NULL DEFAULT 0');
